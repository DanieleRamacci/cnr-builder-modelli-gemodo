...
4. `specs/003-sezioni-placeholder-versionamento/plan.md` for the current technical plan.
5. The active feature's `spec.md` before changing requirements.

The current active feature is `specs/003-sezioni-placeholder-versionamento`.
