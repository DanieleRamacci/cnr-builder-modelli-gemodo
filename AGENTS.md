...
4. `specs/010-configurazione-cataloghi-integrazioni/plan.md` for the current technical plan.
5. The active feature's `spec.md` before changing requirements.

The current active feature is `specs/010-configurazione-cataloghi-integrazioni`.
