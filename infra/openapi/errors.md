...
| `CAMPO_INGLESE_MANCANTE` | Legacy | GEBAN | Codice ritirato | Dal 2026-09-21 la lingua deriva dalla versione modello e ogni campo obbligatorio mancante usa `CAMPO_OBBLIGATORIO` | Aggiornare il client al contratto senza `bando_inglese` | No | `001-catalogo-contratto-geban` |
