...
| `TIPOLOGIA_SOL_NON_VALIDA` | 400 | GEBAN | Tipologia bando non riconosciuta | Il codice tipologia inviato non corrisponde a una `TipologiaBandoSOL` configurata (perimetro iniziale: TDPNRR, CD, DIR, TD, CP, RS, CATP, TI, SDIP, MOB) | Usare uno dei codici tipologia pubblicati nel catalogo | No | `001-catalogo-contratto-geban` |
