...
class ErrorCode(StrEnum):
    DISCOVERY_NON_CONFORME = "DISCOVERY_NON_CONFORME"
    DISCOVERY_NON_DISPONIBILE = "DISCOVERY_NON_DISPONIBILE"
    DISCOVERY_NON_CONFIGURATA = "DISCOVERY_NON_CONFIGURATA"
    ...
    MODELLO_VERSIONE_NON_MODIFICABILE = "MODELLO_VERSIONE_NON_MODIFICABILE"
    VERSIONE_CORRENTE_DUPLICATA = "VERSIONE_CORRENTE_DUPLICATA"
    TRANSIZIONE_STATO_NON_VALIDA = "TRANSIZIONE_STATO_NON_VALIDA"
    CONFERMA_IMPATTO_RICHIESTA = "CONFERMA_IMPATTO_RICHIESTA"
    PLACEHOLDER_NON_VALIDO = "PLACEHOLDER_NON_VALIDO"
...
class BuilderDomainError(DomainError):
    pass
