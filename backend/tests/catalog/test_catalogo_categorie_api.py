...
from app.catalog.schemas import CategoriaDocumentoListResponse, CategoriaDocumentoSchema
...
class FakeCatalogService:
    def list_categorie(self, codice_tipo_documento: str) -> CategoriaDocumentoListResponse:
        return CategoriaDocumentoListResponse(
            ...
            categorie=[CategoriaDocumentoSchema(codice="DEMO", descrizione="Categoria demo")],
        )
...
def test_list_categorie_documento_returns_contract_response(monkeypatch):
    ...
    assert response.json() == {
        ...
        "categorie": [{"codice": "DEMO", "descrizione": "Categoria demo"}],
    }
